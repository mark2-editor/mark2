---
title: Appearance and editor settings
description: Customize Mark2 themes, fonts, texture, layout, and auto-save behavior.
---

# Appearance and editor settings

Open **Settings → Appearance** to make Mark2 feel comfortable, and **Settings → Editor** to change the writing layout.
...
In **Settings → Editor**, you can center the document or align it to the left, show or hide the formatting toolbar, and place the outline on either side of the editor. Auto-save can be off, happen after a short pause, or happen when you switch away from the document.

Local history options are in **Settings → Storage**.
