---
title: 外观与编辑器设置
description: 自定义 Mark2 的主题、字体、纹理、布局和自动保存行为。
---

# 外观与编辑器设置

打开“设置 → 外观”可以让 Mark2 更符合你的习惯；打开“设置 → 编辑器”可以调整写作布局。
...
在“设置 → 编辑器”中，可以选择文档居中或左对齐，显示或隐藏格式工具栏，以及将大纲放在编辑器左侧或右侧。自动保存可以关闭，也可以设置为暂停输入后保存，或切换离开文档时保存。
